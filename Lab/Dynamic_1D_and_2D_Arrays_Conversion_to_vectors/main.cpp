 ...
 * Created on October 9th, 2025, 8:31 PM
 * Purpose:  Converting (Compare 1 and 2 Dimensional Dynamic Arrays) assignment to vectors
 */
...
int main(int argc, char** argv) {
    ...
    //Cleanup (no longed needed since using vectors)
